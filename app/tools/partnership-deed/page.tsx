...
import { ordinal, numWords, formatDateLong, formatDateShort, ordinalSup, cls } from '@/lib/utils';
...
export default function PartnershipDeedPage() {
  ...
  const generateDeed = () => {
    ...
    const dateCommSup = ordinalSup(dateCommencement);
...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;">This Partnership Deed is entered and executed on this ${dateCommSup} out of free will and mutual consent by and between:</p>
${partyParas}
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;">All ${numWords(n)} Parties herein called parties of the ${allOrd} as <b>PARTNERS</b> which term shall mean and include their Heirs, Legal Representatives, Executors, Administrators and Assignees. And whereas the partners have expressed their intention to operate the business in the name and style of <b>"${firmName}"</b> to ${bizNature}.</p>
<div style="display:flex;justify-content:space-between;flex-wrap:wrap;gap:4pt;margin:10pt 0;font-size:13pt;">${initRow}</div>

<div>
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin:16pt 0 6pt;"><b>Now this deed witness is as follows: —</b></p>
...
<li style="margin-bottom:8pt;"><b>Advances and Loans:</b> ${loanText}</li>
<li style="margin-bottom:8pt;"><b>Contracts:</b> All business contracts shall be made in the name of the Firm namely <b>"${firmName}"</b>.</li>
...
<li style="margin-bottom:8pt;"><b>Drawings:</b> Partners may withdraw capital only with others' consent but may freely draw their share of profits credited to their accounts annually.</li>
<li style="margin-bottom:8pt;"><b>Dissolution:</b> The Partnership is at will and may be dissolved by mutual decision. On dissolution, net assets excluding goodwill shall be shared after adjusting excess investments.</li>
</ol></div>

<div>
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;font-style:italic;margin-top:16pt;">In witness whereof the said partners put their hands to this deed of partnership at ${placeExecution}.</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;"><b>${deponent.name}</b>, <b>${deponent.rel} ${deponent.father}</b>, aged <b>${deponent.age} years</b> residing at ${deponent.address} do hereby affirm and state as follows:</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin:10pt 0 6pt;">Solemnly affirmed at ${firm.placeExecution} on this day ${formatDateShort(affData.signDate)}.</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;">Application for the registration of firm by the name <b>"${firm.firmName}"</b> presented to the Registrar of Firms by <b>${f1Data.presentedBy}</b>.</p>
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;">We, the undersigned, being the partners of the firm "<b>${firm.firmName}</b>", hereby apply for registration of the said firm pursuant to Section 58 of the Indian Partnership Act, 1932.</p>
          ...
          <div className="mt-8 pt-6 border-t-2 border-[#f5e9c8]">
            ...
            <div className="border border-[#d6c9a0] rounded-xl mb-3 overflow-hidden">
              <div onClick={() => setOpenSup(s => ({ ...s, aff: !s.aff }))} className="flex items-center gap-3 px-5 py-3 cursor-pointer bg-[#faf7f0] hover:bg-[#f5e9c8] transition-colors">
                ...
                <span className="flex-1 text-sm font-semibold text-[#1a1209]">Affidavit (Owner&rsquo;s Premises)</span>
