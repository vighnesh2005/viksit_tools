...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;"><b>${name}</b>, <b>${rel} ${father}</b>, aged <b>${age} years</b> residing at ${address} do hereby affirm and state as follows:</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin:10pt 0 6pt;">Solemnly affirmed at ${station} on this day ${formatDateShort(signDate)}.</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;">Application for the registration of firm by the name <b>"${firm}"</b> presented to the Registrar of Firms by <b>${presentedBy}</b>.</p>
<p style="font-family:'Bookman Old Style',serif;font-size:13pt;text-align:left;margin-bottom:6pt;">We, the undersigned, being the partners of the firm "<b>${firm}</b>", hereby apply for registration of the said firm pursuant to Section 58 of the Indian Partnership Act, 1932.</p>
...
function SocietyModule() {
  ...
  const generateCover = () => {
    ...
    const html = `<div><div style="text-align:center;font-size:14pt;font-weight:bold;margin-bottom:2pt;font-family:'Bookman Old Style',serif;">${common.name}</div>
<div style="text-align:center;font-size:12pt;margin-bottom:10pt;font-family:'Bookman Old Style',serif;">${common.addr}</div>
<div style="text-align:center;font-size:14pt;font-weight:bold;margin-bottom:10pt;font-family:'Bookman Old Style',serif;">(Registered under Societies Registration Act 35 of 2001)</div>
<div style="margin-top:18pt;font-family:'Bookman Old Style',serif;font-size:12pt;"><b>President</b><br>${pres.name}<br>${pres.rel} ${pres.father},<br>${pres.addr}</div>
<p style="margin-top:18pt;font-family:'Bookman Old Style',serif;font-size:12pt;">To,</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;">The District Registrar of Assurances,<br>The District Registrar Office,<br>${common.place}.</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;">Respected Sir,</p>
<p style="text-indent:36pt;font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;">I am here with enclosing a Memorandum and of the Rules and Regulations of <b>"${common.name}"</b>, Office Address: ${common.addr}, for registration under the Societies Registration Act 35 of 2001. I request that this may kindly be registered under the above said act and issue a necessary certificate of Registration to me. The necessary fee for its registration will be paid in person.</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;">Submitted for necessary action.</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;">Thanking you Sir,</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;">Yours faithfully,</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;"><b>PRESIDENT</b></p>
<div style="display:flex;justify-content:space-between;margin-top:10pt;font-size:12pt;"><span>Place: ${common.place}</span><span>Date: ${formatDateShort(common.date)}</span></div>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 8pt;font-family:'Bookman Old Style',serif;">Enclosures</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;"><li>All members I.D Proofs with photos</li><li>Affidavits – attested by the Notary</li></ul></div>`;
  ...
  const generateResolution = () => {
    ...
    const ms = getMembers();
    const pres = ms.find(m => m.desig === 'President') || ms[0];
    const html = `<div><div style="text-align:center;font-size:14pt;font-weight:bold;text-decoration:underline;margin-bottom:8pt;font-family:'Bookman Old Style',serif;">Copy of Resolution</div>
<div style="text-align:center;font-weight:bold;font-size:14pt;text-transform:uppercase;margin:18pt 0 10pt;font-family:'Bookman Old Style',serif;">Resolution to Form and Register the Society</div>
<p style="text-indent:36pt;font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;">We the undersigned resolved to form a Society by name <b>"${common.name}"</b>, Office Address ${common.addr} and get it registered under the Societies Registration Act 35 of 2001 and also resolved to authorize the <b>PRESIDENT — ${pres.name} ${pres.rel} ${pres.father}</b> of the said Association to present the document in the Registrar's Office, ${common.place} and get it registered under the above said Act and receive the necessary certificate.</p>
<div style="display:flex;justify-content:space-between;margin-top:10pt;font-size:12pt;"><span>Place: ${common.place}</span><span>Date: ${formatDateShort(common.date)}</span></div>
<p style="margin-top:18pt;font-family:'Bookman Old Style',serif;font-size:12pt;"><b>PRESIDENT</b></p>
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 8pt;font-family:'Bookman Old Style',serif;">Annexures</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;"><li>Bye Laws</li><li>ID Proofs</li><li>Affidavit</li></ul></div>`;
  ...
  const generateMoA = () => {
    ...
    const html = `<div><div style="text-align:center;font-size:12pt;font-weight:bold;font-family:'Bookman Old Style',serif;">MEMORANDUM OF ASSOCIATION OF</div>
<div style="text-align:center;font-size:14pt;font-weight:bold;margin-bottom:2pt;font-family:'Bookman Old Style',serif;">${common.name}</div>
<div style="text-align:center;font-size:12pt;margin-bottom:10pt;font-family:'Bookman Old Style',serif;">${common.addr}</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;margin-bottom:6pt;"><b>Name of the Society:</b> ${common.name}</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;margin-bottom:6pt;"><b>Office Address:</b> ${common.addr}</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 8pt;font-family:'Bookman Old Style',serif;">Aims And Objectives:</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;">${aimItems}</ul>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;"><b>Governing Body:</b> We the following mentioned persons in memorandum of Society have formed into a society and are responsible to run the affairs of the society and are desirous of getting the same registered under, the Societies Registration Act 35 of 2001.</p>
<table style="font-size:12pt;font-family:'Bookman Old Style',serif;"><thead><tr><th style="font-size:12pt;">S.No</th><th style="font-size:12pt;">Name</th><th style="font-size:12pt;">Father / Husband Name</th><th style="font-size:12pt;">Address</th><th style="font-size:12pt;">Age</th><th style="font-size:12pt;">Designation</th></tr></thead><tbody>${govTableRows}</tbody></table>
<div style="page-break-before:always">&nbsp;</div>
<div><div style="text-align:center;font-size:14pt;font-weight:bold;text-decoration:underline;margin:16pt 0 0;font-family:'Bookman Old Style',serif;">DECLARATION</div>
<div style="border-bottom:1pt solid #000;margin:4pt 0 8pt 0;"></div>
<table style="font-size:12pt;font-family:'Bookman Old Style',serif;"><thead><tr><th style="font-size:12pt;">S.No</th><th style="font-size:12pt;">Name</th><th style="font-size:12pt;">Father / Husband Name</th><th style="font-size:12pt;">Designation</th><th style="font-size:12pt;">Signature</th></tr></thead><tbody>${dRows}</tbody></table>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 8pt;font-family:'Bookman Old Style',serif;">Signatures Of Witnesses and Their Addresses</div>
<table style="font-size:12pt;font-family:'Bookman Old Style',serif;"><thead><tr><th style="font-size:12pt;">S.No</th><th style="font-size:12pt;">Name</th><th style="font-size:12pt;">Father/Husband Name &amp; Address</th><th style="font-size:12pt;">Signature</th></tr></thead><tbody>${wRows}</tbody></table>
<div style="display:flex;justify-content:space-between;margin-top:10pt;font-size:12pt;"><span>Place: ${common.place}</span><span>Date: ${formatDateShort(common.date)}</span></div></div>

<div style="page-break-before:always">&nbsp;</div>
<div><div style="text-align:center;font-size:12pt;font-weight:bold;text-decoration:underline;margin-bottom:0;font-family:'Bookman Old Style',serif;">RULES AND REGULATIONS OF THE ASSOCIATION</div>
<div style="border-bottom:1pt solid #000;margin:4pt 0 8pt 0;"></div>
<div style="text-align:center;font-size:12pt;margin-bottom:10pt;font-family:'Bookman Old Style',serif;">${common.addr}</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;"><b>Name of the Society:</b> ${common.name}</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;"><b>Office Address:</b> ${common.addr}</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;"><b>Area of Operation:</b> The area of operation of this ${common.name} shall be ${common.area}.</p>
<ol style="list-style-type: decimal; padding-left: 20pt; margin: 0; font-family:'Bookman Old Style',serif; font-size:12pt; text-align:left;">
<li style="margin-bottom:8pt; padding-left: 5pt;"><span style="font-weight:bold;text-decoration:underline;">Membership of the Society:</span><br/>All the persons who are Indian Nationals and above the Age of 18 Years and are of sound Mind and are eligible to the Members of the Society. Their Membership shall be approved By the Executive Committee on acceptance of Rs.${common.admissionFee}/- as an admission Fee and a Monthly Subscription of Rs.${common.monthlySub}/- each. All subscriptions shall be paid every year i.e., before closing the financial year.<br/><br/>Every member shall contribute a monthly subscription of Rs.${common.monthlySub}/- if any member fails to pay the subscriptions for 3 continuous months his name will be deleted from the list of members of the society and all members shall be loyal and faith full to the society.<br/><br/>The membership of the society shall be opened to all and shall not be restricted to any caste, religion, caste, creed, sex etc.,<br/><br/>The Society shall maintain an up-to-date Membership register, records and addresses of all the members with the date of admission and date of termination if any.</li>

<li style="margin-bottom:8pt; padding-left: 5pt;"><span style="font-weight:bold;text-decoration:underline;">Cessation of Membership:</span><br/>Any member shall cease to be a member
<ul style="list-style-type: disc; padding-left: 24pt; margin: 4pt 0 0 0;">
...
<li style="margin-bottom:8pt; padding-left: 5pt;"><span style="font-weight:bold;text-decoration:underline;">Resignation:</span><br/>Resignation by any member shall be through a notice served to the President at least one month in advance, the same shall be placed in the next Managing Committee meeting and acceptance of the same shall be intimated within 10 days of the meeting.</li>

<li style="margin-bottom:8pt; padding-left: 5pt;"><span style="font-weight:bold;text-decoration:underline;">General Body and Function:</span><br/>The General Body shall consist of the founders and Co-Op., members only. They must meet at least once in a year, in the month of January. A Quorum of the General Body shall be 3/5th of the membership. The adjourned meeting of the General Body need not have Quorum. The annual general body meeting shall be convened for the following purposes :
<ul style="list-style-type: disc; padding-left: 24pt; margin: 4pt 0 0 0;">
...
<li style="margin-bottom:8pt; padding-left: 5pt;"><span style="font-weight:bold;text-decoration:underline;">Managing Committee:</span><br/>The complete Management and control of the Society shall rest on the Management Committee of the Society. The Managing Committee of the Society shall consist of a President, a Secretary, treasurer, and 5 members total in 10 members. The members of the managing committee shall be elected at a General Body meeting. The members of the managing committee shall hold the office for a period of 5 years at a time and that period shall and always with the conclusion of an Annual General Body Meeting. The executive committee shall be the authority for the Society for all its functions. The executive body shall consist of not less than and not more than 9 members. The managing committee shall meet at least 4 times in a year by a notice specifying the venue, Agenda, Time of meeting, the notice shall be given to all members at least 10 days in advance.</li>
</ol>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Functions of Managing Committee</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Meeting of the Executive Committee</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Quorum of Executive Committee</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Filling The Vacancies</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">Vacancies  either  permanent  or  casual  caused in  the Society  can  be  filled  by  the  governing  body  by  Co-option  for  the  unexpired  portion of  the  term  of  the  office.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Budget</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">The  managing  committee  shall  present  the  budget  of  Income    and Expenditure  of  the  Society  prepared  by  the  secretary  on  the  aims  and  objects  of  the  Society once  in  a  year  and  get  it  approved  and  adopted.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Functions of the Office Bearers</div>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">President</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">The  President  shall  be  the  overall  in charge  of  the  Society  and  shall  preside  overall  meetings  of  the  Society. He  can  also  advice  the  Secretary  to  call  for  emergency  meetings  of  the  managing  committee  at least  by  giving  3  days  prior  notice.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Secretary</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Treasurer</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Funds</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">Funds  for  the  execution  of  aims  and  objects  of  Society shall  be collected  by  way  of:</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Voting</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">Each   member  shall  have  one  vote,  and  the  co-opted  members  do  not have  any  voting  power. However,  they  can  participate  in discussions on invitation.  In  case  of  a  tie, the  President  shall  have  a  casting  vote.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Amendments</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">No  amendments  or  alterations  shall  be  made  for  the purpose  as  mentioned  in  the   Memorandum  of  Association  unless  it  is  voted  by  3/5th  of   the  members  present  at  a  meeting  of  the  general  body  convened   for  the  purpose  and  confirmed  by  3/5th  of  the  members  present  at  a  second  special   meeting  after  an  interval   of  one  month. Any  amendments  to  the  Byelaws  of  the  Society  will  be  carried  out  only  with the prior  approval  of  the  Commissioner/ Director    of  Income  Tax [ Exemptions ] , Hyderabad.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Winding Up</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">In  the  event  of  dissolution  of  the  Society all  the  remaining  funds and  assets  after  the  full  satisfaction  of  the  liabilities  of  the  Society  shall be given to the Society having  similar aims  and  objects and having  Registration  under  Sec 12 AA  of  the  Income  Tax  Act  1961.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Investments</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">The  surplus  money  of  Society  shall  be  invested  only  in  securities  referred  to  in  Sec  11 ( 5 ) of  Income  Tax   Act  1961.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Property How Deal With</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Disqualifications</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">Any member who has been appointed to the General Body shall cease his membership by any of the reasons stated below or any eventual situations that makes him incapable to continue as the Board member or to act as the Council.</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Financial Year</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">The society shall follow financial year for preparation of annual accounts (i.e 1st April to 31st March).  The trust shall prepare receipts and payments, Income-Expenditure and Balance Sheet on the financial year ending on 31st March every year.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Audit & Accounts</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Proxy</div>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Suit</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">The society shall sue or be sued in the name of the president.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Property</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;margin-bottom:6pt;">Any  Judgment  for  the  recovery of  the property  shall  be  enforced against  the   property of the society only.</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:left;">
...
<div style="page-break-before:always">&nbsp;</div>
<div><div style="text-align:center;font-weight:bold;font-size:14pt;text-transform:uppercase;margin:18pt 0 10pt;font-family:'Bookman Old Style',serif;">Registration Undertaking</div>
<p style="margin-top:14pt;font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;">We, the several members whose signatures are subscribed below desire to bring the above-named society into being within the meaning of Section 35 of 2001 of Societies Registration and we are desirous of getting the above society registered.</p>
<table style="font-size:12pt;font-family:'Bookman Old Style',serif;"><thead><tr><th style="font-size:12pt;">S.No</th><th style="font-size:12pt;">Name &amp; Father / Husband Name</th><th style="font-size:12pt;">Designation</th><th style="font-size:12pt;">Signature &amp; Photo</th></tr></thead><tbody>${finalSigRows}</tbody></table>
<div style="page-break-before:always">&nbsp;</div>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 8pt;font-family:'Bookman Old Style',serif;">Witnesses with their Address &amp; Signatures</div>
<table style="font-size:12pt;font-family:'Bookman Old Style',serif;"><thead><tr><th style="font-size:12pt;">S.No</th><th style="font-size:12pt;">Name &amp; Address</th><th style="font-size:12pt;">Witness Signature</th><th style="font-size:12pt;">Witness Photo</th></tr></thead>
...
<div style="display:flex;justify-content:space-between;margin-top:10pt;font-size:12pt;"><span>Place: ${common.place}</span><span>Date: ${formatDateShort(common.date)}</span></div></div></div></div>
<div style="mso-element:footer;text-align:right;">
  <p style="text-align:right;color:#999999;font-size:8pt;font-family:'Bookman Old Style',serif;margin:0;padding:0;">President: ${pres.name}</p>
</div>`;
...
<div style="text-align:center;font-weight:bold;font-size:14pt;text-transform:uppercase;margin:18pt 0 10pt;font-family:'Bookman Old Style',serif;">President's Affidavit</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;">I, ${pres.name}, ${pres.rel} ${pres.father}, aged about ${pres.age} years, ${pres.addr}, solemnly affirm and sincerely state as follows:</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;">
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;"><b>List of Executive Members along with their Address:</b></p>
<table style="font-size:12pt;font-family:'Bookman Old Style',serif;"><thead><tr><th style="font-size:12pt;">S.No</th><th style="font-size:12pt;">Name</th><th style="font-size:12pt;">Father / Husband Name</th><th style="font-size:12pt;">Address</th><th style="font-size:12pt;">Age</th><th style="font-size:12pt;">Designation</th><th style="font-size:12pt;">Signature</th></tr></thead><tbody>${memberTableRows2}</tbody></table>
...
<div><div style="text-align:center;font-size:14pt;font-weight:bold;text-decoration:underline;margin-bottom:8pt;font-family:'Bookman Old Style',serif;">AFFIDAVIT — 2</div>
<div style="text-align:center;font-weight:bold;font-size:14pt;text-transform:uppercase;margin:18pt 0 10pt;font-family:'Bookman Old Style',serif;">Premises No Objection Certificate (NOC)</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:left;">I, ${owner.name}, ${owner.rel} ${owner.father}${owner.age ? ', aged about ' + owner.age + ' years' : ''},${owner.addr ? ` residing at ${owner.addr},` : ''} do hereby state as follows:</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;">
...
<div style="display:flex;justify-content:space-between;margin-top:10pt;font-size:12pt;"><span>Place: ${common.place}</span><span>Date: ${formatDateShort(common.date)}</span></div>
<div style="margin-top:16pt;text-align:right;font-family:'Bookman Old Style',serif;font-size:12pt;"><b>President</b><br>${pres.name}</div></div>`;
            ...
            <div className="grid md:grid-cols-3 gap-4">
              ...
              <Field label="Designation" required>
                <select className={inputClass} value={members[i]?.desig || SOC_DESIGS[i] || 'Member'} onChange={e => updateMember(i, 'desig', e.target.value)}>
                  {SOC_DESIGS.map((d, i) => <option key={`${d}-${i}`} value={d}>{d}</option>)}
                </select>
              </Field>
