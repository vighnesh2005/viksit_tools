...
<br clear="all" style="page-break-before:always;margin:0;padding:0;line-height:1px;" />
...
<div style="border-bottom:1pt solid #000;margin:4pt 0 8pt 0;"></div>
<div style="text-align:center;font-size:12pt;margin-bottom:10pt;font-family:'Bookman Old Style',serif;">${common.addr}</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;"><b>Name of the Society:</b> ${common.name}</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;"><b>Office Address:</b> ${common.addr}</p>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;"><b>Area of Operation:</b> The area of operation of this ${common.name} shall be ${common.area}.</p>
<ol style="list-style-type: decimal; padding-left: 20pt; margin: 0; font-family:'Bookman Old Style',serif; font-size:12pt; text-align:justify;">
...
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:justify;">
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">Vacancies  either  permanent  or  casual  caused in  the Society  can  be  filled  by  the  governing  body  by  Co-option  for  the  unexpired  portion of  the  term  of  the  office.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Budget</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">The  managing  committee  shall  present  the  budget  of  Income    and Expenditure  of  the  Society  prepared  by  the  secretary  on  the  aims  and  objects  of  the  Society once  in  a  year  and  get  it  approved  and  adopted.</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">Funds  for  the  execution  of  aims  and  objects  of  Society shall  be collected  by  way  of:</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:justify;">
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">Each   member  shall  have  one  vote,  and  the  co-opted  members  do  not have  any  voting  power. However,  they  can  participate  in discussions on invitation.  In  case  of  a  tie, the  President  shall  have  a  casting  vote.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Amendments</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">No  amendments  or  alterations  shall  be  made  for  the purpose  as  mentioned  in  the   Memorandum  of  Association  unless  it  is  voted  by  3/5th  of   the  members  present  at  a  meeting  of  the  general  body  convened   for  the  purpose  and  confirmed  by  3/5th  of  the  members  present  at  a  second  special   meeting  after  an  interval   of  one  month. Any  amendments  to  the  Byelaws  of  the  Society  will  be  carried  out  only  with the prior  approval  of  the  Commissioner/ Director    of  Income  Tax [ Exemptions ] , Hyderabad.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Winding Up</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">In  the  event  of  dissolution  of  the  Society all  the  remaining  funds and  assets  after  the  full  satisfaction  of  the  liabilities  of  the  Society  shall be given to the Society having  similar aims  and  objects and having  Registration  under  Sec 12 AA  of  the  Income  Tax  Act  1961.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Investments</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">The  surplus  money  of  Society  shall  be  invested  only  in  securities  referred  to  in  Sec  11 ( 5 ) of  Income  Tax   Act  1961.</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">Any member who has been appointed to the General Body shall cease his membership by any of the reasons stated below or any eventual situations that makes him incapable to continue as the Board member or to act as the Council.</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:justify;">
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">The society shall follow financial year for preparation of annual accounts (i.e 1st April to 31st March).  The trust shall prepare receipts and payments, Income-Expenditure and Balance Sheet on the financial year ending on 31st March every year.</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">The society shall sue or be sued in the name of the president.</p>
<div style="font-weight:bold;font-size:13pt;margin:14pt 0 6pt;font-family:'Bookman Old Style',serif;">Property</div>
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;margin-bottom:6pt;">Any  Judgment  for  the  recovery of  the property  shall  be  enforced against  the   property of the society only.</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;padding-left:24pt;text-align:justify;">
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;">I, ${pres.name}, ${pres.rel} ${pres.father}, aged about ${pres.age} years, ${pres.addr}, solemnly affirm and sincerely state as follows:</p>
...
<p style="font-family:'Bookman Old Style',serif;font-size:12pt;text-align:justify;">I, ${owner.name}, ${owner.rel} ${owner.father}${owner.age ? ', aged about ' + owner.age + ' years' : ''},${owner.addr ? ` residing at ${owner.addr},` : ''} do hereby state as follows:</p>
<ul style="list-style-type: disc; font-family:'Bookman Old Style',serif;font-size:12pt;">
